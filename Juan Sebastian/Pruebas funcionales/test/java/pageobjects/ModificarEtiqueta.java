...
public class ModificarEtiqueta {
    private final Page page;
    private final Locator searchModificarButton;
    ...
    private final Locator searchEnField;
    private final Locator searchChangeEnOption;
    private final Locator searchGrabarButton;



    public ModificarEtiqueta(Page page){
        this.page = page;
        this.searchModificarButton = page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Modificar"));
        ...
        this.searchEnField = page.getByTitle(" ");
        this.searchChangeEnOption = page.getByRole(AriaRole.OPTION, new Page.GetByRoleOptions().setName(" AutoEtiqueta 2").setExact(true));
        this.searchGrabarButton = page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Grabar"));
    }



    public void clickOnModificarButton(){
        this.searchModificarButton.click();
    }
    ...
    if(En) {
        this.searchEnField.click();
        this.searchChangeEnOption.click();
    }
    this.searchGrabarButton.click();
    }
}