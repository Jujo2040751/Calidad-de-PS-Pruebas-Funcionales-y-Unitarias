...
test('CP18 - Crear nuevo almacén con dirección que no contiene ni letras ni números', async ({ page }) => {

  const datos = {
    "referencia": "011AlmacenDesordenado",
    "nombreDelAlmacen": "Almacén Oeste",
    "direccion": "!!!@@@###$$$",
    "codigoPostal": "28018",
    "ciudad": "Madrid",
    "telefono": "+34 917890123",
    "fax": "+34 917890124",
    "descripcion": "Este almacén, aunque tiene una ubicación un poco peculiar, ofrece una excelente capacidad de almacenamiento con una distribución flexible para todo tipo de mercancías."
  }  
