...
test('CP4 - Crear nuevo almacén con nombre de ubicación válida', async ({ page }) => {

const datos = {
    "referencia": "004AlmacenCentral",
    "nombreDelAlmacen": "Centro de distribución principal",
    "direccion": "Av. Central 200",
    "codigoPostal": "28001",
    "ciudad": "Madrid",
    "telefono": "+34 911112222",
    "fax": "+34 911112223",
    "descripcion": "Almacén que centraliza la distribución general"
  }
