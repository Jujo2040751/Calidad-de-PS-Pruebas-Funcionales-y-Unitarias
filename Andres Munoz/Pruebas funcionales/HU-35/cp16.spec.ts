...
test('CP16 - Modificar almacén con una dirección válida', async ({ page }) => {

  const datos = {
    "referencia": "009AlmacenNuevo",
    "nuevaDireccion": "Centro de distribución modificado",
  }
  ...
  // Modificar almacén
  await page.locator('textarea[name="address"]').fill(datos.nuevaDireccion);
