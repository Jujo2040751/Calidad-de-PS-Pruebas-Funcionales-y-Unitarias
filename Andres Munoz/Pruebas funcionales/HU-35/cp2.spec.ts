...
test('CP2 - Modificar referencia del almacén con una referencia mayor a 30 caracteres', async ({ page }) => {

  const datos = {
    "referencia": "003AlmacenEsteMod",
    "nuevaReferencia": "2222222222222222222222222222222"
  }
