...
test('CP19 - Crear nuevo almacén con código postal válido', async ({ page }) => {

  const datos = {
    "referencia": "012AlmacenComercial",
    "nombreDelAlmacen": "Almacén Central",
    "direccion": "Avenida Libertad 500",
    "codigoPostal": "28030",
    "ciudad": "Madrid",
    "telefono": "+34 918234567",
    "fax": "+34 918234568",
    "descripcion": "Este almacén tiene un diseño moderno y eficiente, con una superficie de 8000 m². Está equipado con sistemas de control de temperatura y espacio para carga pesada."
  }  
