...
test('CP16 - Crear nuevo almacén con dirección válida', async ({ page }) => {

  const datos = {
    "referencia": "009AlmacenNuevo",
    "nombreDelAlmacen": "Almacén Norte",
    "direccion": "Calle 56 #987",
    "codigoPostal": "28015",
    "ciudad": "Madrid",
    "telefono": "+34 915678901",
    "fax": "+34 915678902",
    "descripcion": "Este almacén tiene una amplia capacidad, con 7000 m² de espacio y un sistema de estanterías automatizadas. Su infraestructura fue renovada en 2018 para cumplir con las normativas más recientes de seguridad."
  }
