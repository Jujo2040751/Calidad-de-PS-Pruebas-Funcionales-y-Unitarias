...
test('CP6 - Crear nuevo almacén con nombre de ubicación de más de 50 caracteres', async ({ page }) => {

  const datos = {
    "referencia": "005AlmacenLargo",
    "nombreDelAlmacen": "Almacen con un nombre excesivamente largo que supera los sesenta caracteres",
    "direccion": "Av. Central 201",
    "codigoPostal": "28001",
    "ciudad": "Madrid",
    "telefono": "+34 911112224",
    "fax": "+34 911112225",
    "descripcion": "Este nombre no debería ser aceptado debido a su longitud"
  }
