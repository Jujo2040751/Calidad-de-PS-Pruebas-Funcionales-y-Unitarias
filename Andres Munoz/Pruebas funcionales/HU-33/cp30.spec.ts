...
test('CP30 - Crear nuevo almacén con fax válido', async ({ page }) => {

  const datos = {
    "referencia": "016AlmacenEquipos",
    "nombreDelAlmacen": "Almacén Norte",
    "direccion": "Avenida Técnica 45",
    "codigoPostal": "28010",
    "ciudad": "Madrid",
    "telefono": "+34 913456789",
    "fax": "+34 913456780",
    "descripcion": "Este almacén está orientado al manejo de equipos industriales. Cuenta con áreas de mantenimiento, carga especializada y tecnología de monitoreo en tiempo real."
  }  
