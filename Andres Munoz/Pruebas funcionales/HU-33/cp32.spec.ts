...
test('CP32 - Crear nuevo almacén con fax mayor a 15 caracteres', async ({ page }) => {

  const datos = {
    "referencia": "017AlmacenInnovador",
    "nombreDelAlmacen": "Almacén Sur",
    "direccion": "Calle Futuro 88",
    "codigoPostal": "28020",
    "ciudad": "Madrid",
    "telefono": "+34 914567890",
    "fax": "+34 914567890123456",
    "descripcion": "Almacén moderno con sistemas de energía renovable, robots de picking y conexión directa con centros de distribución. Ideal para operaciones de alta demanda."
  }   
