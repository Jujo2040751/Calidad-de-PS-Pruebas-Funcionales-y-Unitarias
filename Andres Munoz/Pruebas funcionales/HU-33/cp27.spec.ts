...
test('C27 - Crear nuevo almacén con teléfono válido', async ({ page }) => {

  const datos = {
    "referencia": "014AlmacenServicios",
    "nombreDelAlmacen": "Almacén Principal",
    "direccion": "Calle Sol 100",
    "codigoPostal": "28005",
    "ciudad": "Madrid",
    "telefono": "+34 912345678",
    "fax": "+34 912345679",
    "descripcion": "Este almacén está especializado en productos electrónicos, con una gran capacidad de almacenamiento y un sistema de seguridad avanzado. Se ofrece soporte al cliente las 24 horas."
  }
